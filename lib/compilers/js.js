...
exports.JsBuilder = {
		...
		extend(include, {
			...
			fileExtensions: {
				'.js': function (path, context) {
					...
					var ast = exports.JsBuilder._buildJsAst(path, context);
				...
				'.css': function(path, context) {
					...
					if(context.styles.indexOf(path) === -1)
						context.styles.push(path);
	...
	build: function(path, compileOptions, builder){
		...
		var context = exports.JsBuilder._createContext();
...
exports.compile = function (compileOptions, builder) {
	var sourceCode = exports.JsBuilder.build(compileOptions.fromPhysicalPath, compileOptions, builder);
